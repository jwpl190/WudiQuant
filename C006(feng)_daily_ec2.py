...
stock_codes = pd.read_csv(dir + 'codeList', dtype=str)['stock'].values
...
for stock in stock_codes:
    ...
    # Get history prices
    price_data_df = ts.get_hist_data(stock, start=today, end=today,retry_count=10,pause=2)
...
filename = today + "_C006_output.csv"
