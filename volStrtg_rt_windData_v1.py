...
def buyFunc(stock, last, buyType, isDouble, buy_left, vol_last_trade_type,postition):
    if buy_left[stock] > 0:
        ...
        # trade_quantity = someAPI
        updateConfig(stock, ["Position"], [postition + trade_quantity])
        buy_left[stock] = buy_left[stock] - 1
    else:
                    ...
                    if postition == 0:
                        ...
                        if first_time[stock] == True:
                            ...
                            updateConfig(stock,["Position", "EachStockTradeQuantity"],[
                                trade_quantity, trade_quantity / 4]) # postion & volatility strategy trade volume
                        ...
                        if isFixZhisun == True:
                            ...
                            zhisun_p = w.wsd(stock, "MA", prev_t_day, prev_t_day,
                                             "MA_N=" + zhisun_day + ";Fill=Previous;PriceAdj=F").Data[0][-1]
                        # fixed price zhisun
                        if last <= zhisun_p or stock in zhisun_stock_temp:
                            ...
                            # trade_quantity = someAPI
                            ####trade api###
                            updateConfig(stock, ["Position", "StockDailySellable"],[postition - trade_quantity, sellable_quantity - trade_quantity])
                            if stock not in zhisun_stock_temp:
                                zhisun_stock_temp.append(stock)
                            continue
                        # volatility strategy
                            ...
                            if vol_up_open_flag[stock] == True and vol_down_open_flag[stock] == True:
                                ...
                                if range_index == 0:
                                    ...
                                    if vol_last_trade_type[stock] == 'sell2' or vol_last_trade_type[stock] == 'buy2' or \
                                        ...
                                        if checkWeimai(stock) == True:
                                            print(stock, 'a')
                                            sellFunc(stock, last, 'sell1', buy_left, sell_left, vol_last_trade_type,postition)
                                # price is at 2nd interval
                                    ...
                                    if vol_last_trade_type[stock] == 'sell3' or vol_last_trade_type[
                                        ...
                                        if checkWeimai(stock) == True:
                                            print(stock, 'b')
                                            sellFunc(stock, last, 'sell2', buy_left, sell_left, vol_last_trade_type,postition)
                                # price is at 3rd interval
                                    ...
                                    if vol_last_trade_type[stock] == 'sell1':
                                        if checkWeimai(stock) == True:
                                            print(stock, 'c')
                                            buyFunc(stock, last, 'buy2', False, buy_left, vol_last_trade_type,postition)
                                    # last trade was buy5,buy6  --> sell3
                                    elif vol_last_trade_type[stock] == 'buy5' or vol_last_trade_type[stock] == 'buy6':
                                        if checkWeimai(stock) == True:
                                            print(stock, 'd')
                                            sellFunc(stock, last, 'sell3', buy_left, sell_left, vol_last_trade_type,postition)
                                # price is at 4th interval
                                    ...
                                    if vol_last_trade_type[stock] == 'sell1' or vol_last_trade_type[stock] == 'sell2':
                                        if checkWeimai(stock) == True:
                                            print(stock, 'e')
                                            buyFunc(stock, last, 'buy3', False, buy_left, vol_last_trade_type,postition)
                                    # last trade was buy5,buy6  --> sell4
                                    elif vol_last_trade_type[stock] == 'buy5' or vol_last_trade_type[stock] == 'buy6':
                                        if checkWeimai(stock) == True:
                                            print(stock, 'f')
                                            sellFunc(stock, last, 'sell4', buy_left, sell_left, vol_last_trade_type,postition)
                                # price is at 5th interval
                                    ...
                                    if vol_last_trade_type[stock] == 'sell1' or vol_last_trade_type[stock] == 'sell2':
                                        if checkWeimai(stock) == True:
                                            print(stock, 'g')
                                            buyFunc(stock, last, 'buy4', False, buy_left, vol_last_trade_type,postition)
                                # price is at 6th interval
                                    ...
                                    if vol_last_trade_type[stock] == 'sell1' or vol_last_trade_type[
                                        ...
                                        if checkWeimai(stock) == True:
                                            print(stock, 'h')
                                            buyFunc(stock, last, 'buy5', False, buy_left, vol_last_trade_type,postition)
                                # price is at 7th interval
                                    ...
                                    if vol_last_trade_type[stock] == 'sell1' or vol_last_trade_type[
                                        ...
                                        if checkWeimai(stock) == True:
                                            print(stock, 'i')
                                            buyFunc(stock, last, 'buy6', True, buy_left, vol_last_trade_type,postition)
                            # up intervals open
                            ...
                            # down intervals open
                                ...
                                # price is at 3rd interval
                                    ...
                                    if vol_last_trade_type[stock] == 'buy6':
                                        if checkWeimai(stock) == True:
                                            print(stock, 'q')
                                            sellFunc(stock, last, 'sell5', buy_left, sell_left, vol_last_trade_type,postition)
